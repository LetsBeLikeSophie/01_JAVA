...
public class CsiMemberVO {
	...
	public CsiMemberVO(String hnum, String hname, String hid, 
	...
	// HbeMemberVO 프린트 함수 
	public static void printHbeMemberVO(CsiMemberVO hvo) {
	...
	public static void printlnHbeMemberVO(CsiMemberVO hvo) {
